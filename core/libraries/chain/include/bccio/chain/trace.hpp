...
FC_REFLECT( bccio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( bccio::chain::action_trace,
...
FC_REFLECT( bccio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
