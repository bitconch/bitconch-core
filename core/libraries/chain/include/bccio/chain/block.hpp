#pragma once
#include <bccio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( bccio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(bccio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(bccio::chain::transaction_receipt, (bccio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(bccio::chain::signed_block, (bccio::chain::signed_block_header), (transactions)(block_extensions) )
