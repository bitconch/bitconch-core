...
CHAINBASE_SET_INDEX_TYPE(bccio::chain::permission_link_object, bccio::chain::permission_link_index)

FC_REFLECT(bccio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
