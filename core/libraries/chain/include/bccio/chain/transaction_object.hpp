...
CHAINBASE_SET_INDEX_TYPE(bccio::chain::transaction_object, bccio::chain::transaction_multi_index)

FC_REFLECT(bccio::chain::transaction_object, (expiration)(trx_id))
