...
FC_REFLECT( bccio::chain::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( bccio::chain::producer_schedule_type, (version)(producers) )
FC_REFLECT( bccio::chain::shared_producer_schedule_type, (version)(producers) )
