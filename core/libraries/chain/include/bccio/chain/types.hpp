...
namespace bccio { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in BCCIO code:
    *
    ...
    *  others are due to requirements to ensure determinism in the BCCIO chain library.
    *
