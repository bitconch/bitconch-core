...
CHAINBASE_SET_INDEX_TYPE(bccio::chain::code_object, bccio::chain::code_index)

FC_REFLECT(bccio::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
