...
FC_REFLECT( bccio::chain::detail::block_header_state_common,
            (block_num)
...
FC_REFLECT( bccio::chain::detail::schedule_info,
            (schedule_lib_num)
            (schedule_hash)
            (schedule)
)

FC_REFLECT_DERIVED(  bccio::chain::block_header_state, (bccio::chain::detail::block_header_state_common),
                     (id)
                     (header)
                     (pending_schedule)
