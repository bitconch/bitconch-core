...
#include <bccio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(bccio::chain::table_id_object, bccio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(bccio::chain::key_value_object, bccio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(bccio::chain::index64_object, bccio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(bccio::chain::index128_object, bccio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(bccio::chain::index256_object, bccio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(bccio::chain::index_double_object, bccio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(bccio::chain::index_long_double_object, bccio::chain::index_long_double_index)

FC_REFLECT(bccio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(bccio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(bccio::chain::index64_object)
REFLECT_SECONDARY(bccio::chain::index128_object)
REFLECT_SECONDARY(bccio::chain::index256_object)
REFLECT_SECONDARY(bccio::chain::index_double_object)
REFLECT_SECONDARY(bccio::chain::index_long_double_object)
