...
FC_REFLECT(bccio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(bccio::chain::key_weight, (key)(weight) )
FC_REFLECT(bccio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(bccio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(bccio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
