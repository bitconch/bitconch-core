...
using action_name    = bccio::chain::action_name;
...
FC_REFLECT( bccio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( bccio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( bccio::chain::setabi                           , (account)(abi) )
FC_REFLECT( bccio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( bccio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( bccio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( bccio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( bccio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( bccio::chain::onerror                          , (sender_id)(sent_trx) )
