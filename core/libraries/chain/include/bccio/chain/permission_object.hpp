...
CHAINBASE_SET_INDEX_TYPE(bccio::chain::permission_object, bccio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(bccio::chain::permission_usage_object, bccio::chain::permission_usage_index)

FC_REFLECT(bccio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(bccio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(bccio::chain::permission_usage_object, (last_used))
