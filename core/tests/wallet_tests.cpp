 ...
 */
#include <bitconchio/chain/genesis_state.hpp>
#include <bitconchio/wallet_plugin/wallet.hpp>
#include <bitconchio/wallet_plugin/wallet_manager.hpp>

#include <boost/test/unit_test.hpp>
#include <bitconchio/chain/authority.hpp>
...
{ try {
   using namespace bitconchio::wallet;
