...
class P2PTestPeers:
    ...
    ports = [8888] # bitconchiod listening port of each host
    ...
    #ports = [8888, 8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888, 8888] # bitconchiod listening port of each host
