#!/bin/bash
#
# bitconchio-tn_down.sh is used by the bitconchio-tn_bounce.sh and bitconchio-tn_roll.sh scripts.
# It is intended to terminate specific BITCONCH.IO daemon processes.
#
