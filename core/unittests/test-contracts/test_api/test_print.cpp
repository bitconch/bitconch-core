...
void test_print::test_printn() {
   printn(bitconchio::name{"1"}.value);
   printn(bitconchio::name{"5"}.value);
   printn(bitconchio::name{"a"}.value);
   printn(bitconchio::name{"z"}.value);

   printn(bitconchio::name{"abc"}.value);
   printn(bitconchio::name{"123"}.value);

   printn(bitconchio::name{"abc.123"}.value);
   printn(bitconchio::name{"123.abc"}.value);

   printn(bitconchio::name{"12345abcdefgj"}.value);
   printn(bitconchio::name{"ijklmnopqrstj"}.value);
   printn(bitconchio::name{"vwxyz.12345aj"}.value);

   printn(bitconchio::name{"111111111111j"}.value);
   printn(bitconchio::name{"555555555555j"}.value);
   printn(bitconchio::name{"aaaaaaaaaaaaj"}.value);
   printn(bitconchio::name{"zzzzzzzzzzzzj"}.value);
}
...
void test_print::test_print_simple() {
    ...
    bitconchio::print(cvalue);
    std::string value = "value";
    bitconchio::print(std::move(value));
}
