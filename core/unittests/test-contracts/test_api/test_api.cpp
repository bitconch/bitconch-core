...
extern "C" {
   void apply( uint64_t receiver, uint64_t code, uint64_t action ) {
      if( code == "bccio"_n.value && action == "onerror"_n.value ) {
         auto error = bitconchio::onerror::from_current_action();
         bitconchio::print("onerror called\n");
      ...
      //unhandled test call
      bitconchio_assert( false, "Unknown Test" );
