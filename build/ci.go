...
import (
	...
	"github.com/Bitconch/BUS/internal/build"
	"github.com/Bitconch/BUS/params"
	sv "github.com/Bitconch/BUS/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/Bitconch/BUS/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/Bitconch/BUS/mobile")
